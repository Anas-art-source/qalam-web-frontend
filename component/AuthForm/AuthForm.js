  ...
  return (
    <div className={styles.rightContainer}>
      ...
      <p className={styles.description}>
        ...
        dignissimos maiores repudiandae, ratione obcaecati ex harum
        necessitatibus quae, molestiae molli
      </p>
      ...
      <form>
        ...
        <FormFields
          ...
          onChange={setEmail}
          leftIcon={
            <MailOutlineIcon style={{ color: "grey", fontSize: "2.5rem" }} />
          }
        ...
        <FormFields
          ...
          leftIcon={
            <PhoneAndroidIcon style={{ color: "grey", fontSize: "2.5rem" }} />
          }
          placeholder="Type Email Here"
          rightIcon={
            <CheckCircleIcon style={{ color: "green", fontSize: "2rem" }} />
